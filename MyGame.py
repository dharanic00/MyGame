...
def Intro():
	...
	print("")
	print("An evil sorcerer is holding your fellow adventures prisoners.")
...
def create_character_skill_sheet():
	...
	print("""
	Now let's determine your character's skills, which you will use thoroughout the game.
...
def modify_skills():
	...
	print("To modify your skills, roll a six face die for each of your skills, and the game will add you score to the relevant skill")
...
def Scene_2():
	...
	while choice is None:
		user_input=input("""
	From the darkness behind you...you hear a stranger noise.
...
def Scene_3():
	...
	while choice is None:
		user_input=input("""
	From the darkness ahead of you... you hear a stranger noise.
...
def skill_check():
	cls() 
	print("A giant rock falls from the ceiling, roll a die to see if you dodge it...or you will be crashed by it!")
	roll=randint(1,6)
	print("You rolled: "+str(roll))
	if roll+character_dexterity > 10:
		print("""
			You dodged stone and survive! Danger is not over though...
			The strange noise in the darkness continues, and it feels like a lot closer now..""")
		input("Press Enter to continue...")
		combat()
	else:
...
def combat():
	...
	while orc[1] > 0 and character_life > 0:
		...
		if character_life > 0:
			...
			print("You lost....your friends will never br freed....and you are dead")
			input("Press Enter to exit the game")
